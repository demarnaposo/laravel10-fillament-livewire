            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr wire:key='{{ $item['product_id'] }}'>
                    ...
                    <td class="py-4">{{ str_replace('.00', '', Number::currency($item['unit_amount'], 'IDR')) }}
                    </td>
                    <td class="py-4">
                      <div class="flex items-center">
                    ...
                    <td class="py-4">{{ str_replace('.00', '', Number::currency($item['total_amount'], 'IDR')) }}</td>
        ...
        <div class="md:w-1/4">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between mb-2">
              <span>Subtotal</span>
              <span>{{ str_replace('.00', '', Number::currency($grand_total, 'IDR')) }}</span>
            </div>
            <div class="flex justify-between mb-2">
              <span>Taxes</span>
              <span>{{ str_replace('.00', '', Number::currency(0, 'IDR')) }}</span>
            </div>
            <div class="flex justify-between mb-2">
              <span>Shipping</span>
              <span>{{ str_replace('.00', '', Number::currency(0, 'IDR')) }}</span>
            ...
            <div class="flex justify-between mb-2">
              ...
              <span class="font-semibold">{{ str_replace('.00', '', Number::currency($grand_total, 'IDR')) }}</span>
            </div>
            @if ($cart_items)
